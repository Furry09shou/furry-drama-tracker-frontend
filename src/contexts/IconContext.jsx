...
export const ICON_COMPONENT_KEYS = [
  { key: 'nav.home', label: '导航 · 首页', desc: '顶部导航栏「首页」链接旁（配置后显示在链接文字前）' },
  { key: 'nav.search', label: '导航 · 搜索', desc: '导航栏搜索框图标及搜索无结果页的大图示' },
  { key: 'nav.calendar', label: '导航 · 更新日历', desc: '顶部导航栏「更新日历」链接旁' },
  { key: 'nav.timeline', label: '导航 · 动态', desc: '顶部导航栏「动态」链接旁' },
  { key: 'nav.notifications', label: '导航 · 通知', desc: '导航栏「通知」按钮：配置后显示为 图标+文字，未配置时仅显示文字' },
  { key: 'nav.profile', label: '导航 · 个人中心', desc: '顶部导航栏「个人中心」链接旁' },
  { key: 'nav.settings', label: '导航 · 设置', desc: '个人中心/菜单中的「设置」入口旁' },
  { key: 'nav.admin', label: '导航 · 后台', desc: '管理后台入口链接旁' },
  { key: 'nav.theme', label: '导航 · 主题切换', desc: '导航栏主题切换按钮旁' },
  { key: 'nav.language', label: '导航 · 语言切换', desc: '导航栏语言切换按钮旁' },
  { key: 'nav.feedback', label: '导航 · 反馈', desc: '菜单中「用户反馈」项旁' },
  { key: 'action.favorite', label: '操作 · 收藏', desc: '剧集详情页「收藏」按钮旁' },
  { key: 'action.follow', label: '操作 · 关注', desc: '剧集详情页「关注/取消关注」按钮旁' },
  { key: 'action.share', label: '操作 · 分享', desc: '剧集详情与个人中心的「分享」按钮旁' },
  { key: 'action.report', label: '操作 · 举报', desc: '剧集详情页「举报」按钮旁' },
  { key: 'action.edit', label: '操作 · 编辑', desc: '文件夹重命名等「编辑」入口旁' },
  { key: 'action.delete', label: '操作 · 删除', desc: '文件夹删除、移出收藏等「删除」类按钮旁' },
  { key: 'action.upload', label: '操作 · 上传', desc: '封面上传等「上传」按钮旁' },
  { key: 'action.download', label: '操作 · 下载', desc: '「下载」按钮旁' },
  { key: 'action.play', label: '操作 · 播放', desc: '首页「继续观看」栏目标题旁' },
  { key: 'action.close', label: '操作 · 关闭', desc: '弹窗右上角「关闭」按钮旁' },
  { key: 'action.refresh', label: '操作 · 刷新', desc: '「刷新」按钮旁' },
  { key: 'status.playing', label: '状态 · 播出中', desc: '剧集卡片/详情页「播出中」状态徽章旁' },
  { key: 'status.completed', label: '状态 · 已完结', desc: '剧集卡片/详情页「已完结」状态徽章旁' },
  { key: 'status.upcoming', label: '状态 · 未开播', desc: '剧集卡片/详情页「未开播」状态徽章旁' },
  { key: 'tab.latest', label: '标签页 · 最新', desc: '「最新」标签页/栏目标题旁' },
  { key: 'tab.recommended', label: '标签页 · 推荐', desc: '首页「猜你喜欢」栏目标题旁（含登录引导条）' },
